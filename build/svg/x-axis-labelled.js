...
var XAxisLabelled = React.createClass({displayName: 'XAxisLabelled',
  propTypes: {
  ...
  render: function() {
    ...
    return (
      React.DOM.g({className: "axis x-axis x-axis-labelled"}, 
        React.DOM.line({style: lineStyle, x2: this.props.width, y2: 0}), 
          ...
          Lazy.range(this.props.nbSteps).toArray().map(function(stepIdx) {
            ...
            return (
              React.DOM.g({key: 'tick-' + stepIdx, transform: 'translate(' + translateX + ', 0)'}, 
          ...
          Lazy.range(this.props.nbSteps).toArray().map(function(stepIdx) {
            ...
            return (
              React.DOM.g({key: 'label-' + stepIdx, transform: 'translate(' + translateX + ', 0)'}, 
                React.DOM.text({
                  style: style, 
